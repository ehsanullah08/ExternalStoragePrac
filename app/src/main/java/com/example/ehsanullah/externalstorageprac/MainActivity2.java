package com.example.ehsanullah.externalstorageprac;

/**
 * Created by Ehsan Ullah on 10/21/2017.
 */
...
public class MainActivity2 extends AppCompatActivity {
    ...
    public void getPublic(View view) {
        File folder = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MUSIC); // Folder Name
